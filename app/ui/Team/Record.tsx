    ...
    <div className="w-full max-w-[700px] lg:max-w-[1200px] flex flex-col justify-center items-center border border-neutral-400">
      <ul className="w-full flex flex-col lg:flex-row justify-center items-center">
        <div className="lg:flex-[2_2_0%] w-full flex flex-row">
          <li className="flex-1 py-2 flex flex-col justify-center items-center uppercase border-neutral-400 border-t-0 border-b lg:border-b-0 border-l-0 border-r">
            <p className="text-2xl font-bold">
              {team.total_wins} - {team.total_losses}
            </p>
            <p className="text-lg">overall</p>
          </li>
          <li className="flex-1 py-2 flex flex-col justify-center items-center uppercase border-neutral-400 border-t-0 border-b lg:border-b-0 border-l-0 border-r-0 lg:border-r">
            <p className="text-2xl font-bold">
      ...
      <div className="w-full h-12 px-6 flex flex-row justify-between items-center bg-neutral-400">
