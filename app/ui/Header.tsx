...
/* 
<li className="px-2 py-1 border border-neutral-400">
              <Link
                href=""
                className="text-sm text-nowrap hover:text-blue-500 uppercase"
              >
                <span className="font-bold">alabama</span> crimson tide
              </Link>
            </li>
            <li className="px-2 py-1 border border-neutral-400">
              <Link
                ...
                className="text-sm text-nowrap hover:text-blue-500 uppercase"
              >
                <span className="font-bold">arkansas</span> razorbacks
              </Link>
            </li>
            <li className="px-2 py-1 border border-neutral-400">
              <Link
                ...
                className="text-sm text-nowrap hover:text-blue-500 uppercase"
              >
                <span className="font-bold">auburn</span> tigers
              </Link>
            </li>
            <li className="px-2 py-1 border border-neutral-400">
              <Link
                ...
                className="text-sm text-nowrap hover:text-blue-500 uppercase"
              >
                <span className="font-bold">florida</span> gators
              </Link>
            </li>
            <li className="px-2 py-1 border border-neutral-400">
              <Link
                ...
                className="text-sm text-nowrap hover:text-blue-500 uppercase"
              >
                <span className="font-bold">georgia</span> bulldogs
              </Link>
            </li>
            <li className="px-2 py-1 border border-neutral-400">
              <Link
                ...
                className="text-sm text-nowrap hover:text-blue-500 uppercase"
              >
                <span className="font-bold">kentucky</span> wildcats
              </Link>
            </li>
            <li className="px-2 py-1 border border-neutral-400">
              <Link
                ...
                className="text-sm text-nowrap hover:text-blue-500 uppercase"
              >
                <span className="font-bold">lsu</span> tigers
              </Link>
            </li>
            <li className="px-2 py-1 border border-neutral-400">
              <Link
                ...
                className="text-sm text-nowrap hover:text-blue-500 uppercase"
              >
                <span className="font-bold">mississippi state</span> bulldogs
              </Link>
            </li>
            <li className="px-2 py-1 border border-neutral-400">
              <Link
                ...
                className="text-sm text-nowrap hover:text-blue-500 uppercase"
              >
                <span className="font-bold">missouri</span> tigers
              </Link>
            </li>
            <li className="px-2 py-1 border border-neutral-400">
              <Link
                ...
                className="text-sm text-nowrap hover:text-blue-500 uppercase"
              >
                <span className="font-bold">oklahoma</span> sooners
              </Link>
            </li>
            <li className="px-2 py-1 border border-neutral-400">
              <Link
                ...
                className="text-sm text-nowrap hover:text-blue-500 uppercase"
              >
                <span className="font-bold">ole miss</span> rebels
              </Link>
            </li>
            <li className="px-2 py-1 border border-neutral-400">
              <Link
                ...
                className="text-sm text-nowrap hover:text-blue-500 uppercase"
              >
                <span className="font-bold">south carolina</span> gamecocks
              </Link>
            </li>
            <li className="px-2 py-1 border border-neutral-400">
              <Link
                ...
                className="text-sm text-nowrap hover:text-blue-500 uppercase"
              >
                <span className="font-bold">tennessee</span> volunteers
              </Link>
            </li>
            <li className="px-2 py-1 border border-neutral-400">
              <Link
                ...
                className="text-sm text-nowrap hover:text-blue-500 uppercase"
              >
                <span className="font-bold">texas</span> longhorns
              </Link>
            </li>
            <li className="px-2 py-1 border border-neutral-400">
              <Link
                ...
                className="text-sm text-nowrap hover:text-blue-500 uppercase"
              >
                <span className="font-bold">texas a&m</span> aggies
              </Link>
            </li>
            <li className="px-2 py-1 border border-neutral-400">
              <Link
                ...
                className="text-sm text-nowrap hover:text-blue-500 uppercase"
              >
                <span className="font-bold">vanderbilt</span> commodores
              </Link>
            </li>
*/
